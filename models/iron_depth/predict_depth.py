...
import models.iron_depth.utils.utils as utils
from models.iron_depth.models_normal.NNET import NNET
from models.iron_depth.models.IronDepth import IronDepth
...
if __name__ == "__main__":
    iron_depth_type = 'scannet'
    iron_depth_iters = 20
    models_path = 'checkpoints'
    device = 'cuda'
    iron_depth_n_net, iron_depth_model = load_iron_depth_model(
        iron_depth_type,
        iron_depth_iters,
        models_path,
        device)
    ...
    predicted_depth, _ = predict_iron_depth(
        ...
        K=K,
        device=device,
        model=iron_depth_model,
        n_net=iron_depth_n_net,
        input_depth=rendered_depth,
