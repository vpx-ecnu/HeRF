...
class NeuralPoints(nn.Module):
    ...
    def modify_commandline_options(parser, is_train=True):
        # todo: check the setting is the same as kdtree build
        ...
        parser.add_argument('--search_layer_minus',
                            type=int,
                            default=5,
                            help='search nodes under the layer= max-layer - search_layer_minus')
