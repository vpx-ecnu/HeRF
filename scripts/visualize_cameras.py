...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_path", help="Path to data.", default="/media/data/nerf_datasets/whole_datasets/nerf_synthetic/lego")
    parser.add_argument("--multi_scale", help="Whether vis multi camera.", action='store_true')
